...
:::note
For the Red Hat Insights/Telemeter pipeline, customer identity labeling is **not** required on the
OGX side. The Telemeter client authenticates via the cluster's pull secret, which automatically ties
metrics to the customer and subscription.
:::
